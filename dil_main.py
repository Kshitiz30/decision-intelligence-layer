...
with open('startup.log', 'a') as f:
    import datetime
    f.write(f"\n[{datetime.datetime.now()}] DIL Main Starting Up...\n")
# ---------------------------------
...
if __name__ == "__main__":
    logger.info("=" * 80)
    logger.info("DIL - Deterministic Integrity Layer API Server".center(80))
    logger.info("=" * 80)
    ...
    host = "0.0.0.0"
    port_to_use = 5001  # Use fixed port to avoid conflicts
